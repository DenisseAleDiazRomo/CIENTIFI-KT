...
Puedes encontrar la bibliografía de esta investigación [aquí](This%20document%20shows%20a%20practical%20usage%20of%20the%20template.%20I%20use%20the%20Palmer%20penguins%20dataset%20%5B@horst2020%5D%20to%20demonstrate%20the%20features%20of%20the%20template.%20The%20code%20is%20available%20here.).
...
datos_pizza <- read.csv("datos-pizza.csv")

flextable(datos_pizza)
...
flextable::flextable(datos_caracterizacion)
```
